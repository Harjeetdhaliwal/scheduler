...
//stories of DayListItem
  ...
  //Stories of InterviewerListItem
  ...
  .add("Edit", () => (
    <Form name="Archie Cohen" interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")} />
  ))
  .add("Create", () => (
